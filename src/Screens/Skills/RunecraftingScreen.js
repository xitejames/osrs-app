...
export default class RunecraftingScreen extends React.Component {
    ...
    constructor(props) {
        ...
        this.state.currentLevel = cUser.findSkillLevel("Runecrafting");
        this.state.currentExperience = cUser.findSkillExperience("Runecrafting");
        this.state.levelToGet = cUser.findSkillLevel("Runecrafting");
        this.state.experianceToGet = cUser.findSkillExperience("Runecrafting");
        this.updateSkill();
    ...
    updateSkill(){
        Levels.setCurrentSkill('Runecrafting');
            ...
            showsVerticalScrollIndicator={true}>
                <View styles={styles.navBar}>
                    <View style={styles.headItem}>
                        <Text style={styles.textItem}>Runecrafting level: </Text>
                        <TextInput
                    ...
                    <View style={styles.headItem}>
                        <Text style={styles.textItem} >Runecrafting experience: </Text>
                        <TextInput
                        style={styles.inputText}
                    ...
                    <View style={styles.headItem}>
                        <Text style={styles.textItem}>Runecrafting level to get: </Text>
                        <TextInput 
                        style={styles.inputText}
                    ...
                    <View style={styles.headItem}>
                        <Text style={styles.textItem}>Runecrafting experience to get: </Text>
                        <TextInput
                        style={styles.inputText}
